...
//    userInfo[FJSelectedControllerKey] = viewController;
//    userInfo[FJSelectedControllerIndexKey] = @(tabBarController.selectedIndex);
    
    // 发通知
    NSLog(@"%@", FJTabBarDidSelectNotification);
